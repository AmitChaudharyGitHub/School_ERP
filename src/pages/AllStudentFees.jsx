...
function AllStudentFees() {
    ...
    useEffect(() => {
        ...
        fetch("https://localhost:44377/api/student/GetStudentProfileByStudentID/1")
            .then((res) => res.json())
            .then((data) => {
                setStudentData(data);
            });
            ...
            <div className="page-header d-flex justify-content-between align-items-center gap-3 flex-wrap">
                <div>
                    ...
                    <div className="breadcrumb-lite d-flex align-items-center gap-2 small mt-1">
                        <span>Dashboard</span><span>/</span><span>Fees</span><span>/</span><span>All Student Fees</span>
                    </div>
                </div>
                        ...
                        <div className="col-md-11">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-4">
                                    ...
                                    <p className="mb-2">
                                        <strong>Father Name :</strong> Ganesh Pawar
                                    </p>

                                    <p className="mb-2">
                                        <strong>Mother Name :</strong> Vaishali Pawar
                                    </p>

                                    <p className="mb-0">
                                        <strong>Mobile :</strong> 9876543226
                                    </p>
                                ...
                                <div className="col-md-4">
                                    ...
                                    <p className="mb-2">
                                        <strong>Standard :</strong> 5th
                                    </p>

                                    <p className="mb-2">
                                        <strong>School :</strong> Green Valley School
                                    </p>
                                    ...
                                    <tr key={index}>
                                        <td>
                                            <span
                                                ...
                                                onClick={() =>
                                                    navigate(`/studentFee/${item.StudentID}`)
                                                }
                                            >
                                                {item.StudentID}
                                            </span>
